...
import com.springboot.shop.service.image.IImageService;
...
public class ImageController {
    ...
    @PostMapping("/upload")
    public ResponseEntity<ApiResponse> saveImage(@RequestParam List<MultipartFile> files, @RequestParam Long product_id) {
        try {
            List<ImageDto> ImageDto=imageService.saveImages(files,product_id);
